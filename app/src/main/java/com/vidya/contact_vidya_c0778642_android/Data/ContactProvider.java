...
class ContactProvider extends ContentProvider {
    ...
    private
    Uri insertContact(Uri uri, ContentValues values) {
    ...
    @Override
    public
    int update(Uri uri, ContentValues contentValues, String selection,
    ...
    private
    int updateContact(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
