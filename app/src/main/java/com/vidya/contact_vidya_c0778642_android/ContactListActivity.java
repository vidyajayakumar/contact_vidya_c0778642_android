...
class ContactListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    void insertContact() {
        ...
        values.put(ContactEntry.COLUMN_FirstNAME, "Vidya");
        values.put(ContactEntry.COLUMN_LastNAME, "Jayakumar");
        values.put(ContactEntry.COLUMN_PHONE, "+123456789");
        values.put(ContactEntry.COLUMN_EMAIL, "vvallive@gmail.com");
